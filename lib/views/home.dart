...
class _HomeState extends State<Home> {
  ...
  Future<void> options() async {
    ...
    for (int i = 0; i < answerArray.length; i++) {
      this.a.add(
        // if hint is in
          (hintLocations.contains(i)) ? Container(
            width: 40,
            height: 40,
          ...
          DragTarget(onWillAccept: (value) {
            ...
            if (playerAnswer.length ==
              ...
              if (playerAnswer ==
                ...
                (currentLivesLeft == 0) ? lifeFinished(context) : showDialog(
                ...
                child: ListView.separated(
                    itemBuilder: (context, index) {
                      ...
                      */
                          ...
                          int arrayIndex =
                              rng.nextInt(this.answerArrayCopy.length - 1);
                      ...
                      print("the size of the guessarray is $guessesArray");
                      return Row(
                          ...
                          Draggable(
                            ...
                            feedback: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black)),
                              child:
                                  Center(child: Text(guessesArray[index][0])),
                            ),
                          ...
                          Draggable(
                            ...
                            feedback: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black)),
                              child:
                                  Center(child: Text(guessesArray[index][1])),
                            ),
                            childWhenDragging: Container(
                              width: 40,
                              height: 40,
                          ...
                          Draggable(
                            ...
                            feedback: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black)),
                              child:
                                  Center(child: Text(guessesArray[index][2])),
                            ),
                            childWhenDragging: Container(
                              width: 40,
                              height: 40,
                          ...
                          Draggable(
                            ...
                            feedback: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black)),
                              child:
                                  Center(child: Text(guessesArray[index][3])),
                            ),
                            childWhenDragging: Container(
                              width: 40,
                              height: 40,
